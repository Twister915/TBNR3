...
import net.tbnr.dev.commands.DonatedCommand;
...
import net.tbnr.dev.setting.ToggleSettingCommand;
...
public final class TBNRHub extends ModularPlugin {
    ...
    protected void onModuleEnable() throws Exception {
        ...
        registerCommand(new DonatedCommand());
        registerCommand(new ToggleSettingCommand());
